...
define( [], function canva() {
	...
	BlockType = function( imgClass, height, width ) {
		try {
...
//			pacmanMove(p3,0);
		...
		addPacman = function( player, column, row, angle ) {
			/*
		...
		pacmanMove = function( pacman, direction, eaten ) {
			/*
		...
		addBlock = function( type, column, row ) {
			/*
